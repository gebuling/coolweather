...
import com.wang.coolweather.gson.Forecast;
import com.wang.coolweather.gson.Weather;
import com.wang.coolweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId +
                "&key=110ae80cf3a5496680f0a608c95a9835";
        HttpUtil.SendOkHttpRequest(weatherUrl, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                Log.d(TAG, "forecastList size is : " + weather.forecastList.size());
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
